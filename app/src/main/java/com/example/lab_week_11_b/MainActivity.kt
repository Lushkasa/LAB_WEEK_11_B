...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.video_button).setOnClickListener {
            ...
            // 👉 panggil fungsi izin kamera dan mikrofon di sini
    ...
    // 👉 Tempatkan fungsi izin runtime di sini (setelah checkStoragePermission)
    private fun checkCameraAndAudioPermission(onGranted: () -> Unit) {
